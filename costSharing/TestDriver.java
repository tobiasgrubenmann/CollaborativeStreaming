...
public class TestDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        List<Integer> queryParemters = Arrays.asList(1, 10, 100, 1000, 10000);
            ...
            for (Double probability : probabilityParameters) {
                ...
                for (int i = 0; i < ITERATIONS; ++i) {
                    ...
                    for (Node query : scenario.getLeaves()) {
                        allocations.add(new Allocation(query, 1000000, random.nextDouble(), 1000000));
                    }
                ...
                //System.out.println(numberOfQueries + ", " + probability + ", " + (scenario.getCostNodes().size()+scenario.getLeaves().size()));
